...
saveGrid = function(grid) {
      ...
      grid.engine.nodes.forEach(function(node) {
        ...
        serializedData.push({
         ...
         // value:node.el.children[0].children[0].children[1].children[0].value
        });
      });
      addRemoveButton();
    ...
    loadGrid = function(grid,data) {
      ...
      items.forEach(function (node) {
       ...
       grid.el.lastChild.children[0].children[0].children[0].children[1].children[0].value=node.value;
      });
      grid.commit();
    };
